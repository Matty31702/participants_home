    ...
    <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <div className="relative">
                    ...
                    {isEventsDropdownOpen && (
                      <div
                        className="absolute z-10 mt-2 w-48 origin-top-right rounded-md bg-customColor_yellow text-customColor_black py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                        role="menu"
      ...
      <section className="relative bg-blue-500 h-custom-60">
        <div className="flex items-center justify-center h-full bg-black bg-opacity-50">
          <h1 className="text-white text-4xl">Events Page</h1>
        </div>
      </section>
